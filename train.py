...
def train(args, loader, generator, discriminator, g_optim, d_optim, g_ema, device):
    ...
    for idx in pbar:
        ...
        noise = mixing_noise(args.batch, args.latent, args.mixing, device) # Style-mixing with prob 0.9 (default)
        fake_img, _ = generator(noise)

        if args.augment:
            fake_img, _ = augment(fake_img, ada_aug_p) # Non-leaking adaptive augmentation
...
if __name__ == "__main__":
    ...
    if args.arch == 'stylegan2':
        ...
        elif args.version == 'cdc':
            from model_cdc import Generator, Discriminator
        else:
            raise ImportError
